const VideoFileDuotoneLine = (props) => {
    return (
        <svg
        ...
        >
            <g fill="none">
                ...
                <path
                    ...
                    strokeWidth="1.2"
                    d="m13.855 14.08l-3.182-1.364A1.2 1.2 0 0 0 9 13.82v2.36a1.2 1.2 0 0 0 1.673 1.103l3.182-1.364c.808-.347.808-1.492 0-1.838"
                ></path>
                <path
                    stroke="currentColor"
                    strokeWidth="1.2"
                    d="M13 3v4c0 .943 0 1.414.293 1.707S14.057 9 15 9h4"
                ></path>
            </g>
        </svg>
    )
