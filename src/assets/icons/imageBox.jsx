const ImgBoxDuotoneLine = (props) => {
    return (
        ...
        >
            <mask
                id="letsIconsImgBoxDuotoneLine0"
                width="18"
                height="18"
                x="3"
                y="3"
