const WavingHand = (props) => {
    return (
        ...
        >
            ...
            <clipPath id="notoWavingHand1">
                <use href="#notoWavingHand0"></use>
            </clipPath>
            <g fill="#FAA700" clipPath="url(#notoWavingHand1)">
            ...
            <defs>
                <use href="#notoWavingHand0" id="notoWavingHand2"></use>
            </defs>
            <clipPath id="notoWavingHand3">
                <use href="#notoWavingHand2"></use>
            </clipPath>
            <g fill="#B55E19" clipPath="url(#notoWavingHand3)">
